          ...
          <form className="space-y-4" onSubmit={e=>toast.promise(handleSaveProfile(e),{loading:'Saving...'})}>
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              >
                ...
                <input
                  ...
                  accept="image/*"
                  id="profile_picture"
                  className="w-full p-3 border border-gray-200 rounded-b-lg "
                  onChange={(e) =>
                    setEditForm({
                      ...editForm,
                  ...
                  <img
                    src={
                      editForm.profile_picture
                        ...
                        : (user.profile_picture || assets.sample_profile)
                    }
                    alt=""
                  ...
                  <img
                    src={
                      editForm.cover_photo
                        ...
                        : (user.cover_photo || assets.sample_cover)
                    }
                    alt=""
            ...
            <div className="flex justify-end space-x-3 pt-6">
              <button
                ...
                type="button"
                className="px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-color cursor-pointer"
              >
                Cancel
              </button>
