          ...
          <form className='space-y-4' onSubmit={handleSaveProfile}>
            ...
            <div className='flex flex-col items-center gap-3'>
              <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>
                Profile Picture
                <input hidden type='file' accept="image/*" id='profile_picture' className='w-full p-3 border border-gray-200 rounded-b-lg ' onChange={(e)=>setEditForm({...editForm,profile_picture:e.target.files[0]})}/>
            ...
            <div className='flex flex-col items-center gap-3'>
              <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                Cover Photo
                <input hidden type='file' accept="image/*" id='cover_photo' className='w-full p-3 border border-gray-200 rounded-b-lg ' onChange={(e)=>setEditForm({...editForm,cover_photo:e.target.files[0]})}/>
            ...
            <div className='flex justify-end space-x-3 pt-6'>
              <button onClick={()=>setShowEdit(false)} type="button" className='px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-color cursor-pointer'>Cancel</button>
